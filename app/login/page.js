...
const Login = () => {
    ...
    return (
        ...
        // </div>
        <div className='flex'>
    <div className='h-[100vh] w-[30vw]' style={{ backgroundImage: 'url("/login-bg21.png")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="logo px-3 inline-block">
            <Link href="/"><Image src="/logo.png" width={70} height={70} alt='logo'/></Link>
        </div>
        <div className='flex flex-col items-center justify-center h-full'>
            <h2 className={`${poppins.className} text-gray-100 text-2xl font-extrabold tracking-wider`}>Sign in to your account</h2>
